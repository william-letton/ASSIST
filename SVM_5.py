...
##Create the SVMdata object from the articles list. The vocabulary and data arrays
##will be created based on only the word/codon content of the articles that will be
##used for training.
FibratesData=createSVMdata(inputArticles,"word")

##Create a SVMdataobject from the articles list that only uses articles that have
##chosen to be part of the training set.
