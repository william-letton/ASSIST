...
##Here data is imported as .csv and three lists of data are extracted.
...
##Process the data into a list of IDs, a list of Abstract texts, a list of assignments.
##Assignments are designated as 0 for EX and 1 for IN.
inputDataLists=createData()

############################################################

##Here the entire classifier program is wrapped into a single function.
##The input of this fuction is the inputDataLists object, containing a list of:
#   IDs
#   Unprocessed abstract text
#   Assignments (0 and 1 for EX and IN)
##The output of this function is the outputDataLists, containing a list of:
#   IDs
#   Probability values (not between 0 and 1)
def SVMclassProbabilities(inputDataLists):
    ...
    ##specified.
    def PickTrainingArticles(inputDataLists):
        seed(1)
    ...
    def CreateTrainingIDsLists(trainingIDlist):
        seed(2)
    ...
    ##Input is a dictionary of a C parameter values. The funtion takes these
    ...
    trainingIDlist=PickTrainingArticles(inputDataLists)
    #print(trainingIDlist)

    ##Create a list of lists of the training abstract IDs for each classifier (usually two).
    trainingIDgroups=CreateTrainingIDsLists(trainingIDlist)
    ...
    ##Create list of IDs and list of probabilities to return.
    returnIDlist=SVMdata.ID_all
    returnProbList=SVMdata.SVMvote_mean
    return(returnIDlist,returnProbList)
outputDataLists=SVMclassProbabilities(inputDataLists)
