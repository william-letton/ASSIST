...
##Below input the detail for testing articles. For 3rd screener functionality
##Testing and training articles are the same.
testingArticles=trainingArticles
